...
public class MaintainabilityIntegrationTest {
  ...
  /*
   * Stubs: None
   * Real: HalsteadMetrics, CyclomaticComplexity, ExecutableStatementCount, CommentCounter
   */

  @Test
  public void testMaintainabilityIntegration()
  {
    maintainabilityIndex = new MaintainabilityIndex();
    ...
    //Following 4 calls should give CommentCounter 10 numComments
